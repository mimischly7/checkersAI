...
def test():
    ...
    for _ in range(n):
        ...
        # ----- depth 3 -----
        # other_game, winner = run_game(PrunelessMinimaxer(2), Randomizer())
        # other_game, winner = run_game(Randomizer(), PrunelessMinimaxer(3))

        # ----- depth 3 TREE-----
        other_game, winner = run_game(PrunelessMinimaxerWithTree(2), Randomizer())
...
def testAggress():
    ...
    for _ in range(n):
        ...
        # ----- depth 3 TREE-----
        #other_game, winner = run_gameaggressive(AdvancedAggressor('B', 2), Randomizer())
        other_game, winner = run_game(SimpleAggressor('B'), Randomizer())
        # other_game, winner = run_game(Randomizer(), PrunelessMinimaxerWithTree(3))
